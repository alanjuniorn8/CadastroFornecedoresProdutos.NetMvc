...
namespace CadastroFornecedores.Extensions
{
    ...
    {
        public static bool ValidarClaimUsuarido(HttpContext context, string claimName, string claimValue)
        {
    ...
    public class RequisitoClaimFilter : IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if(!CustomAuthorization.ValidarClaimUsuarido(context.HttpContext, _claim.Type, _claim.Value))
            {
